    ...
    <section className="bg-background py-20">
      <div className="m-auto max-w-7xl px-6">
        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-10 items-center justify-items-center">
          ...
          {/* === Cloud & Data === */}
          <img className="h-20" src="/postgresql-ar21.svg" alt="PostgreSQL" />
          <img className="h-20" src="/sqlserver.svg" alt="SQL Server" />
          <img className="h-20" src="/mongo.svg" alt="MongoDB" />
          <img className="h-20" src="/CouchDB.svg" alt="CouchDB" />
          <img className="h-20" src="/Oracle.svg" alt="Oracle" />
          <img className="h-20" src="/Apache Cassandra.svg" alt="Cassandra" />
          ...
          <img className="h-20" src="/Express.svg" alt="Express.js" />
          ...
          <img className="h-20" src="/DockerSvg.svg" alt="Docker" />
          ...
          <img className="h-20" src="/jupyter.svg" alt="Jupyter" />
          ...
          <img className="h-20" src="/Apache_Spark_logo.svg.svg" alt="Apache Spark" />
          <img className="h-20" src="/terra.svg" alt="Terraform" />
